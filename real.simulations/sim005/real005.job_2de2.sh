...
#SBATCH -q normal
# nombre
#SBATCH -J sm4_simul_pp_at_real005-part2
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=120:00:00
# archivos de salida y de error
#SBATCH -o files.o/sm4_simul_pp_at_real005-part2_%A_%a.o
#SBATCH -e files.e/sm4_simul_pp_at_real005-part2_%A_%a.e
# directorio de trabajo por defecto
#SBATCH -D .
# notificaciones por email relacionadas con la ejecucion del trabajo
#SBATCH --mail-user=aitor.vazquez.veloso@uva.es
#SBATCH --mail-type=ALL
#SBATCH --array=1-25678


# ejecución de las simulaciones de Pinus pinaster atlantica (costa e interior) - parte 2 de 2

ROOT=/home/uva_iufor_1/uva_iufor_1_2/simulator/simulator  # ruta de la carpeta simulator (anterior a src) dentro del simulador
SCNR=/scratch/uva_iufor_1/uva_iufor_1_2/real005/scenario/part_2/scnr_ppat_${SLURM_ARRAY_TASK_ID}.json  # ruta donde se encuentran los escenarios dentro del HPC
