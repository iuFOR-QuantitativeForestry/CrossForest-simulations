...
#SBATCH -q normal
# nombre
#SBATCH -J Script.make.scenarios.real002
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=1:00:00
# archivos de salida y de error
#SBATCH -o Script.make.scenarios.real002-%j.o
#SBATCH -e Script.make.scenarios.real002-%j.e
...
OUT_Dir=/scratch/uva_iufor_1/uva_iufor_1_3/real/real002
