...
#SBATCH -q normal
# nombre
#SBATCH -J Python.Plot.split.real003
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=10:00:00
# archivos de salida y de error
#SBATCH -o Python.Plot.split.real003-%j.o
#SBATCH -e Python.Plot.split.real003-%j.e
...
OUT_Dir=/scratch/uva_iufor_1/uva_iufor_1_3/real003

CurrentDir=$(pwd)
cd $OUT_Dir
# ejecution of Python script to split excel file into individual files

python $ROOT/splitInputExcel2indPlots.py real003 _pure_IFN.csv csv
