...
#SBATCH -q normal
# nombre
#SBATCH -J sm4_simul_sim003-test
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=06:00:00
# archivos de salida y de error
#SBATCH -o sm4_simul_sim003-test.o
#SBATCH -e sm4_simul_sim003-test.e
...
SCNR=/scratch/uva_iufor_1/uva_iufor_1_3/sim003/scenario/scnr_sp999_1_100-100.json
