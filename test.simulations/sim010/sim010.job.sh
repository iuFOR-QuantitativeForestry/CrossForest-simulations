...
#SBATCH -q normal
# nombre
#SBATCH -J sm4_simul_sim010-from1to22500
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=120:00:00
# archivos de salida y de error
#SBATCH -o sm4_simul_sim010-array_%A_%a.o
#SBATCH -e sm4_simul_sim010-array_%A_%a.e
...
SCNR=/scratch/uva_iufor_1/uva_iufor_1_3/sim010/scenario/scnr_sp999_${SLURM_ARRAY_TASK_ID}_4-100.json
