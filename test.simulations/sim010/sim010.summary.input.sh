...
#SBATCH -q normal
# nombre
#SBATCH -J compile_simul_sim010
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=60:00:00
# archivos de salida y de error
#SBATCH -o compile_input_simul_sim010.o
#SBATCH -e compile_input_simul_sim010.e
...
python $ROOT/resumeCSVs.py sim010 30000 10 input
