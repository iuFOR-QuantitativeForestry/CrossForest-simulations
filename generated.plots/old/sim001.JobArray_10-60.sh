...
#SBATCH -q normal
# nombre
#SBATCH -J sm4_simul_sim001
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=01:00:00
# archivos de salida y de error
#SBATCH -o sm4_simul_sim001-array_n1_%A_%a.o
#SBATCH -e sm4_simul_sim001-array_n1_%A_%a.e
...
SCNR=/scratch/uva_iufor_1/uva_iufor_1_3/sim001/scenario/scnr_sp999_${SLURM_ARRAY_TASK_ID}_10-60.json
