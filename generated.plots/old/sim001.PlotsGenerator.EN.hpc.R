...
data.folder <- '/home/uva_iufor_1/COMUNES/simanfor/data/simul/sim001' ## folder to write files in HPC
## data.folder <- '~/simanfor/data/simul/sim001' ## folder to write files in PC

## supply default values
id.file <- 1
sp <- 26 # species spNFIcode
n.p <- 10 # number of plots
n.t <- 50 # number of trees per plot
age0 <- 20 # mean plot age
ht.m <- 15 # mean height
dbh.m <- 12 # mean dbh
