...
#SBATCH -q normal
# nombre
#SBATCH -J RScrpt.Plot.Generator.sim002
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=01:00:00
# archivos de salida y de error
#SBATCH -o RScrpt.Plot.Generator.sim002-%j.o
#SBATCH -e RScrpt.Plot.Generator.sim002-%j.e
...
SCR_Dir=~/scripts
OUT_Dir=/scratch/uva_iufor_1/uva_iufor_1_3/sim002/input
...
i=1
while [ $i -le $nf ]; do
    ~/scripts/PlotsGenerator.R id.file=$i sp=999 n.p=$np n.t=$nt age0=25 ht.m=12 dbh.m=11 tph=1111 var.d=4 var.h=2
    ((i++))    
done
cd $CurrentDir
