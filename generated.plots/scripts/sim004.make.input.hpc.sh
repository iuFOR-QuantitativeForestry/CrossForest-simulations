...
#SBATCH -q normal
# nombre
#SBATCH -J RScrpt.Plot.Generator.sim004
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=01:00:00
# archivos de salida y de error
#SBATCH -o RScrpt.Plot.Generator.sim004-%j.o
#SBATCH -e RScrpt.Plot.Generator.sim004-%j.e
...
SCR_Dir=~/scripts
OUT_Dir=/scratch/uva_iufor_1/uva_iufor_1_3/sim004/input
