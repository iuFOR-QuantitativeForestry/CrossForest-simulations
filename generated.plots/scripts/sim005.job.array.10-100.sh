...
#SBATCH -q normal
# nombre
#SBATCH -J sm4_simul_sim005
# tiempo maximo de ejecucion (p.e. 2 dias). Maximo permitido: 5 dias
#SBATCH --time=05:00:00
# archivos de salida y de error
#SBATCH -o sm4_simul_sim005-array_%A_%a.o
#SBATCH -e sm4_simul_sim005-array_%A_%a.e
...
SCNR=/scratch/uva_iufor_1/uva_iufor_1_3/sim005/scenario/scnr_sp999_${SLURM_ARRAY_TASK_ID}_10-100.json
